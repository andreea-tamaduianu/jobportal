...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model, @RequestParam(value="job", required = false) String job, @RequestParam(value="location", required=false) String location,
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
                List<RecruiterJobsDto> recruiterJobsDtos=jobPostActivityService.getRecruiterJobs(((RecruiterProfile)currentUserprofile).getUserAccountId());
